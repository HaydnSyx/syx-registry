...
public class SyxRegistryService implements RegistryService {
    ...
    @Override
    public synchronized InstanceMeta register(String serviceName, InstanceMeta serviceMeta) {
    ...
    @Override
    public synchronized InstanceMeta unregister(String serviceName, InstanceMeta serviceMeta) {
        List<InstanceMeta> metas = REGISTRY.get(serviceName);
